...
var sidebar = require("sdk/ui/sidebar").Sidebar({
    ...
    onAttach: function(worker) {
        // Store the sidebar port so it can be communicated with from outside this function
        sidebarPort = worker.port;

        // Set width constraints on the sidebar
        sidebarElement.setAttribute("style", "min-width:200px;max-width:500px;");

        // Functions for storing and retrieving the current state (currently only stores the active plan ID)
        ...
        // Listen for new pages visited and send the page details to the sidebar
        ...
        /*
         * Load more details (to be shown in the right pane) about a list item when selected
         */
        ...
        /* End of list item selection */


        // Generic group name updating (for pages and criteria groups)
        ...
        /* End of existing criteria getters */
    ...
    onShow: function() {
        // Set sidebar to default width when shown
...
/* End of edit page panel */


/*
 * Edit criterion panel
 */
...
/* End of edit criterion panel */


/*
 * Report generator
 * (This could probably be moved to its own module file)
 */
 ...
 * Based on http://www.kendsnyder.com/posts/firefox-extensions-add-button-to-nav-bar and https://gist.github.com/fwenzel/2269233
 * (From Firefox 29 onwards this could be replaced with a toggle button: https://developer.mozilla.org/en-US/Add-ons/SDK/Low-Level_APIs/ui_button_toggle)
 */
